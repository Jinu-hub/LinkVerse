      ...
      <div className="max-w-2xl mx-auto space-y-6">
        ...
        <div className="flex justify-center gap-4 flex-wrap">
          <Link to="/join" viewTransition>
            <Button size="lg" className="text-lg px-8 py-6 bg-blue-600 hover:bg-blue-700 text-white dark:bg-blue-500 dark:hover:bg-blue-600 dark:text-zinc-900">회원가입</Button>
          </Link>
