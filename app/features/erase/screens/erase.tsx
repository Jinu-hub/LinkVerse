...
const RESULTS = [
  ...
  "화성 탐사선에게 맡겨두었습니다. 돌아오지는 않을 거예요.",
  "블랙홀에 넣었더니 흔적도 없이 사라졌습니다. 영수증은 없습니다.",
  "토성 고리 사이에 끼워두었습니다. 찾으려면 29년쯤 걸립니다. 더 걸리려나?",
  ...
  "별똥별이 되어 떨어졌습니다. 그런데 이건 왜 떨어지는거지?",
  ...
  "명왕성이 행성에서 밀려날 때 같이 넣어 뒀습니다. 그 후 더욱 더 멀리 밀려났다고 하네요.",
  ...
  "태양 가까이에 두고 왔습니다. 지금쯤 문장 부호까지 전부 타버렸을 거예요.",
  "태양 흑점에 던져 넣었습니다. 당분간은 누구도 꺼낼 수 없습니다.",
  "금성의 구름 아래 숨겨두었습니다. 찾으러 가기에는 날씨가 너무 나쁩니다.",
  "금성으로 보냈습니다. 아름답긴 한데 다시 가지는 마세요.",
] as const;
