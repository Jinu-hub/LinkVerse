...
CREATE TYPE "public"."ui_type_codes" AS ENUM('default', 'list', 'card', 'grid', 'timeline', 'table', 'calendar', 'map', 'chart', 'gallery', 'tab');--> statement-breakpoint
...
CREATE UNIQUE INDEX "ui_type_unique_index" ON "ui_type" USING btree ("ui_type_code");--> statement-breakpoint
